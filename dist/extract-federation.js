...
async function run() {
    const envelopeUrl = pathToFileURL(path.resolve("./src/federation-envelope.ts")).href;
    ...
    writeFileSync("federation.json", JSON.stringify(mod.WSTP_PRODUCTION_FEDERATION, null, 2));
